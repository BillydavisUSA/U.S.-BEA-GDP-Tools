...
const messages = Object.freeze({
  en: Object.freeze({
    ...
    "meta.description": "Explore official U.S. GDP and population data by metro area, city, state, or country.",
    ...
    "hero.title": "Metro, city, state, and national data in one query.",
    "hero.description": "Search metro areas, cities, states, or the country, then export a ready-to-use Excel workbook.",
    "hero.msas": "MSAs",
    "hero.csas": "CSAs",
    ...
    "scope.cityGeographies": "City · {count} county geographies",
    ...
    "scope.validationCity": "Select a city or choose all cities.",
    ...
    "about.p1": "U.S. BEA GDP Tools is a free, open-source project for retrieving GDP and population data from the U.S. Bureau of Economic Analysis. The website supports national, state, metropolitan, and user-defined city analysis, with county-level detail retained for MSA, CSA, and city exports. The installed Windows and Android applications are unchanged.",
  ...
  zh: Object.freeze({
    ...
    "meta.description": "按都会区、城市、州或国家层级查询美国官方 GDP 与人口数据。",
    "a11y.skip": "跳至查询工具",
    ...
    "hero.title": "美国数据查询系统：全国、州、都会区和城市 GDP 与人口数据",
    "hero.description": "搜索都会区、城市、州或全国数据，选择 BEA 指标并导出 Excel 工作簿。",
    "hero.msas": "大都市统计区",
    "hero.csas": "联合统计区",
    ...
    "about.p1": "U.S. BEA GDP Tools 是一个免费、开源的项目，用于获取美国经济分析局（BEA）发布的 GDP 与人口数据。网页端支持国家、州、都会区及自定义城市层级分析，并在 MSA、CSA 和城市导出结果中保留县级明细；Windows 与 Android 应用保持不变。",
